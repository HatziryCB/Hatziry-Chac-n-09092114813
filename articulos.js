...
function tarifas(form){
    ...
    if (pvl.value=="1") {
        ...
        switch (value) {
            case "Guatemala":
                console.log(trpeso)
                alert("Tipo de artículo a transportar: Artículos Electrónicos, Destino: "+ value +" " + "con una distancia de : "+ dep.value + " " + "kilometros, la tarifa total a cancelar es de: Q"+ trpeso);
                break;
            case "Izabal":
                console.log(trpeso)
                alert("Tipo de artículo a transportar: Artículos Electrónicos, Destino: "+ value +" " + "con una distancia de : "+ dep.value + " " + "kilometros, la tarifa total a cancelar es de: Q"+ trpeso);
        ...
        switch (value) {
            case "Guatemala":
                console.log(tvol)
                alert("Tipo de artículo a transportar: Artículos Electrónicos, Destino: "+ value +" " + "con una distancia de : "+ dep.value + " " + "kilometros, la tarifa total a cancelar es de: Q"+ tvol);
                break;
            case "Izabal":
                alert("Tipo de artículo a transportar: Artículos Electrónicos, Destino: "+ value +" " + "con una distancia de : "+ dep.value + " " + "kilometros, la tarifa total a cancelar es de: Q"+ tvol);
                break;
